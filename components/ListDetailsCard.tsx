        ...
        <Box display="flex" alignItems="center" overflow="hidden">
          ...
          <VStack spacing={2} align="stretch" p={4}>
            ...
            <Text isTruncated noOfLines={2}>
              ...
              Architecto cumque laboriosam, provident tempore dignissimos eaque
              voluptates dolore incidunt! Pariatur debitis laborum reprehenderit
              accusamus nulla soluta provident dolorem consequuntur omnis error.
            </Text>
